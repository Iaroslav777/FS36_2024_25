...
// Інтерфейс для стану компонента Content
...
class HomeworkPage extends Component {
  ...
  footerData: FooterData = {
    ...
    author: "Бабік Ярослав", // Додано ім'я автора
  };
...
// Компонент Content (класовий, типізований, з демонстрацією інтерполяції, лічильника, подій та запитів на бекенд)
...
class MyEvents extends Component<{}, MyEventsState> {
  ...
  handleCut(event: React.ClipboardEvent<HTMLInputElement>): void {
    ...
    // console.log("Текст вирізано:", event.clipboardData.getData('text')); // Доступ до clipboardData може бути обмежений в деяких середовищах
    setTimeout(
      () =>
        this.setState({
          cutCopyMessage: "Спробуйте вирізати/скопіювати текст",
  ...
  handleCopy(event: React.ClipboardEvent<HTMLInputElement>): void {
    ...
    // console.log("Текст скопійовано:", event.clipboardData.getData('text')); // Доступ до clipboardData може бути обмежений в деяких середовищах
    setTimeout(
      () =>
        this.setState({
          cutCopyMessage: "Спробуйте вирізати/скопіювати текст",
